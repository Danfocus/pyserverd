...
@author: danfocus
'''
from defines import SN_IES_AUTHxREQUEST, MISMATCH_PASSWD, SN_IES_LOGINxREPLY,\
    SN_TYP_REGISTRATION, FLAP_FRAME_DATA, SN_IES_AUTHxKEY, SN_IES_AUTHxLOGIN,\
    AIM_MD5_STRING
...
def parse_snac_registration(sn_sub,connection,str_):
